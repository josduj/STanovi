...
const argv = require('yargs')
	...
	.option('u', {boolean: true, default: undefined, describe: 'only user submitted ads'})
...
async function main () { 
	...
	query.userOnly = util.selectBoolean('Bez agencija? ', argv.u)
	query.adsWithImages = util.selectBoolean('Samo sa slikom? ', argv.p)
	query.date = new Date()
	util.print()
